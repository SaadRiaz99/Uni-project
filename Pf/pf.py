...
def show_main_menu():
    ...
    for text, command in buttons:
        tk.Button(main_container, text=text, width=40, height=2, command=command,
                  bg="gray", fg="white", font="georgia,20").pack(pady=5)
...
def book_appointment_screen():
    ...
    def confirm():
        patient_name = patient_cb.get()
        doctor_name = doctor_cb.get()
        date = entry_date.get()
...
def view_appointments_screen():
    ...
    if not appointments:
        ...
        for a in appointments:
            tk.Label(
                main_container,
                text=f"{a.get('patient', '')} with {a.get('doctor', '')} , "
                     f"{a.get('specialization', 'N/A')} on {a.get('date', '')}",
                bg="white"
            ).pack()
...
doctors = [
    ...
    {"id": 6, "name": "Dr. Fatima ", "specialization": "Radiology", "shift": "morning"},
    ...
    {"id": 11, "name": "Dr. Usman", "specialization": "Orthopedic", "shift": "Morning"},
    {"id": 12, "name": "Dr. Zainab", "specialization": "Gynecologist", "shift": "Evening"},
    {"id": 13, "name": "Dr. Bilal", "specialization": "Psychiatrist", "shift": "Morning"},
    {"id": 14, "name": "Dr. Maryam", "specialization": "Physiotherapist", "shift": "Evening"},
    {"id": 14, "name": "Dr. Saad Bin Riaz", "specialization": "Physiotherapist", "shift": "Evening"}
